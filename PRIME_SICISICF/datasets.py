...
- Caching Paradigms: `CachingTMSEEGClassification`, `CachingTMSEEGClassificationTEP`,
  `CachingTMSEEGClassificationTEPfree`, and nSICI/SICF/Single pulse paradigms
  handle the specifics of data extraction and caching for different TMS-EEG data types.
"""
...
# Import the new SICI/SICF classes
from TMS_EEG_SICI_SICF_moabb import (
    SICIClassification,
    SICFClassification,
...
PARADIGM_DATA = {
    "CUSTOM_CLS": {
        ...
        "class_map": {
            ...
            "SICIClassification": SICIDataset,
            "SICFClassification": SICFDataset,
            "SinglePulseClassification": SinglePulseDataset,
        },
        "specs": {
            ...
            "SICIClassification": dict(sr=1000, sec=0.494, n_cls=2),  # -0.5 to -0.020 = 0.48s
            "SICFClassification": dict(sr=1000, sec=0.494, n_cls=2),
            "SinglePulseClassification": dict(sr=1000, sec=0.494, n_cls=2),
        },
    },
}
...
def load_cached_pretrain_data(
    ...
    paradigm_class_map = {
        ...
        "SICIClassification": CachingSICIClassification,
        "SICFClassification": CachingSICFClassification,
        "SinglePulseClassification": CachingSinglePulseClassification,
    }
...
# NEW CACHING CLASSES FOR SICI/SICF/SINGLE PULSE
class CachingSICIClassification(BaseCachingParadigm, SICIClassification):
    """Caching wrapper for the SICIClassification paradigm."""

    def __init__(self, num_trials_per_subject: Optional[int] = None, **kwargs):
        super(CachingSICIClassification, self).__init__(
            data_type="SICI",
            num_trials_per_subject=num_trials_per_subject,
            **kwargs,
        )
        # Initialize the actual paradigm logic
        SICIClassification.__init__(self, **kwargs)


class CachingSICFClassification(BaseCachingParadigm, SICFClassification):
    """Caching wrapper for the SICFClassification paradigm."""

    def __init__(self, num_trials_per_subject: Optional[int] = None, **kwargs):
        super(CachingSICFClassification, self).__init__(
            data_type="SICF",
            num_trials_per_subject=num_trials_per_subject,
            **kwargs,
        )
        # Initialize the actual paradigm logic
        SICFClassification.__init__(self, **kwargs)


class CachingSinglePulseClassification(BaseCachingParadigm, SinglePulseClassification):
    """Caching wrapper for the SinglePulseClassification paradigm."""

    def __init__(self, num_trials_per_subject: Optional[int] = None, **kwargs):
        super(CachingSinglePulseClassification, self).__init__(
            data_type="SinglePulse",
            num_trials_per_subject=num_trials_per_subject,
            **kwargs,
        )
        # Initialize the actual paradigm logic
        SinglePulseClassification.__init__(self, **kwargs)
...
__all__ = [
    ...
    "CachingSICIClassification",
    "CachingSICFClassification", 
    "CachingSinglePulseClassification",
    "PARADIGM_DATA",
]
# %%